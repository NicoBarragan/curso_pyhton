...
#         num = {}
#         for i in palabra:
#             num.update(enumerate(palabra))

#         print(o)
#         guion_list = {'- ' for i in num}    

#         num_intento = {}
#         preg = str(input('acá: '))
#         for i in preg:
#             num_intento.update(enumerate(preg))
...
def run():
    ...
    words = []
    with open('./data.txt', 'r', encoding='utf-8') as file: # Here we get the words from the file and make a list
        for line in file:
    ...
    points = 0
    while keep_trying:
        os.system('clear') #This line cleans the screen in every try
